...
public class GuardianConsentController {
 ...
 @PostMapping("/verify") public Map<String,String> verify(Authentication a,@RequestBody GuardianVerifyRequest body,HttpServletRequest request){service.verify(a.getName(),body,request.getRemoteAddr(),request.getHeader("User-Agent"));return Map.of("message","Guardian consent verified successfully. Your registration is complete and active.");}
